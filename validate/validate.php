...
if ($validationType == 'php')
{
    ...
    //which returns the page the vistor shold be redirected to
...
{
    // AJAX validation is performed by he ValidateAJAX method.
    //The result are used to form a JSON document that is sent 
    //back to the client
